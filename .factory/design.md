...
Generation provenance: generated 2026-08-28 using the Param Factory Azure image generation deployment via `/opt/fleet/lib/gen-image.sh`. Original project asset; reviewed for text artifacts, brands, unintended symbols, and seams. Source PNG and prompt sidecar live in `assets/src/`; optimized AVIF (60 KB), WebP (76 KB), and JPEG fallback (124 KB) ship in `public/assets/`. Generated imagery is disclosed in the footer.
